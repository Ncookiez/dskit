...
export const weth: { [chainId: number]: { address: Lowercase<Address>; decimals: number } } = {
  ...
  [gnosis.id]: { address: '0x6a023ccd1ff6f2045c3309768ead9e68f978f6e1', decimals: 18 },
  ...
  [polygon.id]: { address: '0x7ceb23fd6bc0add59e62ac25578270cff1b9f619', decimals: 18 },
...
export const usdc: { [chainId: number]: { address: Lowercase<Address>; decimals: number } } = {
  ...
  [polygon.id]: { address: '0x2791bca1f2de4661ed88a30c99a7a9449aa84174', decimals: 6 },
