export const zapRouterABI = [
  { inputs: [{ internalType: 'address', name: '_permit2', type: 'address' }], stateMutability: 'nonpayable', type: 'constructor' },
  {
    inputs: [
  ...
  { inputs: [{ internalType: 'address', name: 'caller', type: 'address' }], name: 'CallerNotZap', type: 'error' },
  { inputs: [{ internalType: 'address', name: 'recipient', type: 'address' }], name: 'EtherTransferFailed', type: 'error' },
  {
    inputs: [
  ...
  { inputs: [{ internalType: 'address', name: 'target', type: 'address' }], name: 'TargetingInvalidContract', type: 'error' },
  {
    anonymous: false,
    inputs: [
      {
